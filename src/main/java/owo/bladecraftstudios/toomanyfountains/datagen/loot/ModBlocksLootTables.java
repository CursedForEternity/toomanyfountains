...
public class ModBlocksLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(DWBlocks.HOT_PATH.get());
        this.dropSelf(DWBlocks.HOT_ROCK.get());
        this.dropSelf(DWBlocks.OCEAN_DIRT.get());
        this.dropOther(DWBlocks.OCEAN_SLATE.get(), DWBlocks.COBBLED_SLATE.get());
        this.dropSelf(DWBlocks.SLATE_BRICKS.get());
        this.dropSelf(DWBlocks.SMOOTH_SLATE.get());
        this.dropSelf(DWBlocks.COBBLED_SLATE.get());
        this.dropSelf(DWBlocks.POLISHED_SLATE.get());
        this.dropSelf(DWBlocks.POLISHED_DEEPSTONE.get());
        this.dropSelf(DWBlocks.DEEPSTONE_BRICKS.get());
        this.dropSelf(DWBlocks.SMOOTH_DEEPSTONE.get());
        this.dropSelf(DWBlocks.COBBLED_DEEPSTONE.get());
        this.dropSelf(DWBlocks.CHISELED_DEEPSTONE.get());
        this.dropSelf(DWBlocks.CHISELED_SLATE.get());
        this.dropOther(DWBlocks.DEEPSTONE.get(), DWBlocks.COBBLED_DEEPSTONE.get());
