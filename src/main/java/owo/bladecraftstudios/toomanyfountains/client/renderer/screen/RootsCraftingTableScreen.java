package owo.bladecraftstudios.toomanyfountains.client.renderer.screen;
...
import owo.bladecraftstudios.toomanyfountains.client.renderer.RenderBlitUtil;
import owo.bladecraftstudios.toomanyfountains.client.renderer.menu.RootsCraftingTableMenu;

import java.util.Random;

public class RootsCraftingTableScreen extends AbstractContainerScreen<RootsCraftingTableMenu> implements RecipeUpdateListener {
    private static final ResourceLocation CRAFTING_TABLE_LOCATION = new ResourceLocation(TooManyFountains.MODID, "textures/gui/roots_crafting_table_menu.png");
    private static final ResourceLocation CRAFTING_TABLE_GLOW_LOCATION = new ResourceLocation(TooManyFountains.MODID, "textures/gui/roots_crafting_table_menu_glow.png");
    private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation(TooManyFountains.MODID,"textures/gui/roots/recipe_button.png");
    ...
    public RootsCraftingTableScreen(RootsCraftingTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void renderLabels(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY) {
        ...
        pGuiGraphics.drawString(this.font, Component.translatable("gui.toomanyfountains.roots.dark_world_inventory_title"), this.inventoryLabelX, this.inventoryLabelY, -1, false);
    }
