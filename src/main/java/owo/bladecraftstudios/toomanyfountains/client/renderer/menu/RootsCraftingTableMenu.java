package owo.bladecraftstudios.toomanyfountains.client.renderer.menu;
...
public class RootsCraftingTableMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public RootsCraftingTableMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, ContainerLevelAccess.NULL);
    }

    public RootsCraftingTableMenu(int pContainerId, Inventory pPlayerInventory, ContainerLevelAccess pAccess) {
        super(DWMenu.ROOTS_CRAFTING_TABLE.get(), pContainerId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(this.access, pPlayer, DWBlocks.ROOTS_CRAFTING_TABLE.get());
    }
