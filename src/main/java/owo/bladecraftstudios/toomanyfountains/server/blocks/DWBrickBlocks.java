...
public class DWBrickBlocks {
    ...
    public static final RegistryObject<Block> ICESALT_BRICKS_STAIRS = DWBlocks.registerBlock("icesalt_bricks_stairs",
            () -> new StairBlock(() -> DWBlocks.ICESALT_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.DEEPSLATE).emissiveRendering((state, reader, pos) -> true).lightLevel((state) -> 0)));
    ...
    public static final RegistryObject<Block> HAILSTONE_BRICKS_STAIRS = DWBlocks.registerBlock("hailstone_bricks_stairs",
            () -> new StairBlock(() -> DWBlocks.HAILSTONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.DEEPSLATE).emissiveRendering((state, reader, pos) -> true).lightLevel((state) -> 15)));
    ...
    public static final RegistryObject<Block> SUBZERO_STONE_BRICKS_STAIRS = DWBlocks.registerBlock("subzero_stone_bricks_stairs",
            () -> new StairBlock(() -> DWBlocks.SUBZERO_STONE_BRICKS.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.DEEPSLATE).emissiveRendering((state, reader, pos) -> true).lightLevel((state) -> 15)));
    ...
    public static final RegistryObject<Block> FROST_MARBLE_BRICKS_STAIRS = DWBlocks.registerBlock("frost_marble_bricks_stairs",
            () -> new StairBlock(() -> DWBlocks.FROST_MARBLE.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE).sound(SoundType.DEEPSLATE).emissiveRendering((state, reader, pos) -> true).lightLevel((state) -> 15)));
