...
public class ModRecipeProvider  extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, DWCircusBlocks.CIRCUS_FLOOR.get())
                .pattern("S")
                .pattern("D")
                .define('S', Items.PURPLE_CARPET)
                .define('D', DWCircusBlocks.CIRCUS_BOARDS.get())
                .unlockedBy(getHasName(Items.PURPLE_CARPET), has(DWCircusBlocks.CIRCUS_BOARDS.get()))
                .save(pWriter);
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
        for(ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult,
                    ...
                    .save(pFinishedRecipeConsumer,  TooManyFountains.MODID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemlike));
        }
    }
}